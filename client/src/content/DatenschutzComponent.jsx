...
class DatenschutzComponent extends React.Component {
  render() {
    return (
      <>
        ...
        <p>
          ...
          zu diesen Tools und &uuml;ber Ihre Widerspruchsm&ouml;glichkeiten
          finden Sie in der folgenden Datenschutzerkl&auml;rung.
        </p>
        <h2>2. Hosting</h2>
        ...
        <p>
          Alina Kr&auml;hahn
          <br />
          R&ouml;merstra&szlig;e 365 A<br />
          47178 Duisburg
        </p>
        <p>
